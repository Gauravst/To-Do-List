...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="flex flex-col px-40 justify-center items-center h-[100vh] pt-[10vh]"
    >
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="text-center text-lg my-3 px-6 text-gray-600">
          Maximize efficiency with our streamlined to-do app. Prioritize tasks,
          set reminders, and achieve your goals effortlessly. Synchronize
          seamlessly across devices for uninterrupted productivity. Take control
          of your day and conquer your to-do list!
        </p>
      </div>
      <div className="flex gap-x-8">
        <div className="bg-gray-950 h-12 mt-5 w-fit px-4 flex items-center rounded-md cursor-pointer border border-gray-950 transition duration-500 hover:bg-opacity-60 hover:border-opacity-20">
          <Link className="text-white text-sm font-medium" href={user ? "/dashboard" : "/login"}>
